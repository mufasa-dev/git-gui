...
export default function TagList(props: TagListProps) {
  ...
  return (
    <div class="mt-3 border-t border-gray-300 dark:border-gray-700 pb-2">
      <div class="flex items-center w-full px-2 py-2 cursor-pointer border-b border-gray-300 dark:border-gray-700" onClick={() => setOpen(!open())}>
