      ...
      <div class="flex items-center justify-between mb-6">
        <div class="flex items-center gap-4">
            <span class="text-sm font-bold dark:text-gray-200">
              <i class="fa fa-code-commit text-green-500"></i> {props.calendar?.totalContributions.toLocaleString('pt-BR')} contribuições no último ano
            </span>
        </div>
      </div>
                                ...
                                {(day: any) => {
                                    ...
                                    return (
                                        <div 
                                            ...
                                            title={`${day.contributionCount} contribuições em ${new Date(day.date + "T00:00:00").toLocaleDateString()}`}
                                        />
                                    );
                                }}
                            </For>
